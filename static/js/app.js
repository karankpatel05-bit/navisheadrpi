...
class NavisApp {
        ...
        initSpeechRecognition() {
                ...
                this.recognition.onerror = (e) => {
                        ...
                        // Stop continuous if we hit a serious error like no speech matches multiple times? 
                        // Actually 'no-speech' happens when silent. In continuous mode we just let it restart.
                };
